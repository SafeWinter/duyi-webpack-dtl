...
![2020-02-12-09-53-01](../../assets/42.1.png)
...
**永远不要过早地关注性能**，因为开发时无法完全预知最终的运行性能，过早地关注性能会极大降低开发效率。

要把精力放在代码的可读性和可维护性上，例如尾递归优化，会让可读性大大降低。



性能优化主要从上面三个维度入手。

***性能优化没有完美解决方案，需要具体情况具体分析***。