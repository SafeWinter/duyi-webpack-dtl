...
module.exports = __webpack_require__(/*! ../../full/observable */ "./node_modules/core-js/full/observable/index.js");
...
/* harmony import */ var _rx_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./rx.js */ "./src/rx.js");
var _ref, _ref2, _ref3, _ref4, _Observable$of;
...
/*!*******************!*\
  !*** ./src/rx.js ***!
  \*******************/
/*! exports provided: map, filter, skip, reduce, ReactiveExtensions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "map", function() { return _map; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "filter", function() { return _filter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "skip", function() { return _skip; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "reduce", function() { return _reduce; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReactiveExtensions", function() { return ReactiveExtensions; });
/* harmony import */ var core_js_features_observable_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/features/observable/index.js */ "./node_modules/core-js/features/observable/index.js");
/* harmony import */ var core_js_features_observable_index_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_features_observable_index_js__WEBPACK_IMPORTED_MODULE_0__);
...
var _curry = function curry(fn) {
  return function () {
    for (var _len = arguments.length, args1 = new Array(_len), _key = 0; _key < _len; _key++) {
      args1[_key] = arguments[_key];
    }
    return args1.length === fn.length ? fn.apply(void 0, args1) : function () {
      for (var _len2 = arguments.length, args2 = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        args2[_key2] = arguments[_key2];
      }
      var args = [].concat(args1, args2);
      return args.length >= fn.length ? fn.apply(void 0, _toConsumableArray(args)) : _curry(fn).apply(void 0, _toConsumableArray(args));
    };
  };
};
var _map = _curry(function (fn, stream) {
...
var _filter = _curry(function (predicate, stream) {
  return new Observable(function (observer) {
    var subs = stream.subscribe({
      next: function next(value) {
        if (predicate(value)) {
...
var _skip = _curry(function (count, stream) {
  var skipped = 0;
  return new Observable(function (observer) {
    var subs = stream.subscribe({
      next: function next(value) {
...
var _reduce = _curry(function (accumulator, initialValue, stream) {
  var result = initialValue !== null && initialValue !== void 0 ? initialValue : {};
  return new Observable(function (observer) {
    var subs = stream.subscribe({
      next: function next(value) {
